...
public class TypeUtil {
    ...
    public static Object valueOf( Class<?> type, String value ) {
        try {
            ...
            if ( type.equals( Character.TYPE ) || type.equals( Character.class ) ) return value.charAt( 0 );
    ...
    public static int parseInt( String s, int offset, int length, int base ) throws NumberFormatException {
        s = Normalizer.normalize( StringUtil.empty( s, "" ), Normalizer.Form.NFKC );
    ...
    public static int parseInt( byte[] b, int offset, int length, int base ) throws NumberFormatException {
        ...
        for ( int i = 0; i < length; i++ ) {
            ...
            if ( digit < 0 || digit >= base ) throw new NumberFormatException( new String( b, offset, length ) );
            value = value * base + digit;
        }
        return value;
    }
    ...
    public static byte convertHexDigit( byte c ) {
        ...
        if ( b < 0 || b > 15 ) throw new IllegalArgumentException( "!hex " + c );
        return b;
    }
